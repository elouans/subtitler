...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log('Extracted timeStep:', timeStep);
    ...
    console.log('Shifting subtitles...');
    await processSubtitles(inputPath, outputPath, timeStep);

    console.log('Reading processed content...');
    ...
    res.setHeader(
      'Content-Disposition',
      `attachment; filename="adjusted_${originalFilename}"`
    );
